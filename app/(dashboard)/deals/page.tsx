        ...
        <Card className="border-border bg-card shadow-sm overflow-hidden">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Total Pipeline</p>
        ...
        <Card className="border-border bg-card shadow-sm overflow-hidden border-l-4 border-l-emerald-500">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Received Amount</p>
        ...
        <Card className="border-border bg-card shadow-sm overflow-hidden border-l-4 border-l-amber-500">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Total Pending</p>
        ...
        {isLoading ? (
          ...
          <Card className="border-2 border-dashed border-border bg-card/50">
            <CardContent className="py-20 flex flex-col items-center justify-center text-muted-foreground">
              ...
              <p className="font-bold uppercase tracking-widest text-xs">No Active Deals Found</p>
              ...
              <Card key={deal.id} className="border-border bg-card hover:shadow-xl hover:shadow-primary/5 transition-all group overflow-hidden">
                <CardContent className="p-0 flex flex-col md:flex-row md:items-center">
                  <div className="flex-1 p-5 md:p-6 space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm font-bold text-muted-foreground uppercase tracking-wider">{deal.company || "Direct Client"}</p>
                      </div>
                      
                      <div className="flex flex-col items-end">
                        <div className="text-xs font-bold text-muted-foreground uppercase mb-1">Deal Progression</div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                      ...
                      <div className="bg-emerald-50/50 dark:bg-emerald-500/5 p-2.5 rounded-xl border border-emerald-500/10">
                        <p className="text-[10px] font-bold text-emerald-600 uppercase">Total Received</p>
                      ...
                      <div className="bg-primary/5 p-2.5 rounded-xl border border-primary/10">
                        <p className="text-[10px] font-bold text-primary uppercase">Next Due</p>
                  ...
                  <div className="bg-muted/20 border-t md:border-t-0 md:border-l border-border p-4 flex md:flex-col gap-2 shrink-0 h-full">
                    <Button 
                      variant="outline" 
                      className="flex-1 rounded-xl h-10 border-border bg-background hover:bg-muted text-xs font-bold uppercase tracking-widest"
                      onClick={() => {
                    ...
                    <Button 
                      className="flex-1 rounded-xl h-10 bg-primary text-white hover:bg-primary/90 text-xs font-bold uppercase tracking-widest shadow-lg shadow-primary/10"
                      onClick={() => {
                         setEditingDealId(deal.id);
                         setIsFormOpen(true);
                      }}
