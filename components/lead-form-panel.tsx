    ...
    if (leadData && !isLoading) {
      form.reset({
        ...
        dealDetails: {
          ...
          paymentDate: leadData.dealDetails?.paymentDate
  ...
  const dealTrackingContent = (
    <div className='space-y-6 pt-4 border-t border-border mt-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" className="h-10 rounded-xl bg-primary/5 font-bold text-primary" {...field} value={field.value ?? ""} />
              </FormControl>
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" className="h-10 rounded-xl bg-emerald-500/5 font-bold text-emerald-600" {...field} value={field.value ?? ""} />
              </FormControl>
            </FormItem>
          )}
        />
        ...
        />
        {watchedPaymentPlan === "one-time" && (
          <FormField
            control={form.control}
            name='dealDetails.paymentDate'
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-xs font-semibold tracking-wider text-muted-foreground">Payment Date</FormLabel>
                <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      ...
                      <FormControl>
                        <Input type="date" className="h-8 text-xs rounded-lg" {...field} value={field.value ?? ""} />
                      </FormControl>
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      ...
                      <FormControl>
                        <Input type="number" className="h-8 text-xs rounded-lg font-bold" {...field} value={field.value ?? ""} />
                      </FormControl>
                    </FormItem>
                  )}
                />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input className="h-10 rounded-xl bg-muted/10 border-border focus:bg-background focus:ring-4 focus:ring-primary/10 transition-all" placeholder='John Doe' {...field} value={field.value ?? ""} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input className="h-10 rounded-xl bg-muted/10 border-border focus:bg-background focus:ring-4 focus:ring-primary/10 transition-all" placeholder='9876543210' {...field} value={field.value ?? ""} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className='md:col-span-2'>
                          ...
                          <FormControl>
                            <Input placeholder='Partner Name' {...field} value={field.value ?? ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder='Admin User' {...field} value={field.value ?? ""} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
