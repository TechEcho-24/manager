          ...
          >
            ...
            <div className='space-y-6 max-w-sm sm:max-w-md w-full'>
              ...
              <div className='flex flex-col items-center gap-3'>
                ...
                <span
                  className='text-[9px] font-bold uppercase tracking-[0.4em] text-white/20'
      ...
      <div className='w-full max-w-[1100px] flex flex-col lg:flex-row overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 bg-[#0a0a1a]/60 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.8)] backdrop-blur-[40px]'>
        ...
        <div className='hidden lg:flex flex-1 flex-col p-12 overflow-hidden border-r border-white/10 relative'>
          ...
          <Link href='/' className='relative z-10 block'>
            <div className='flex flex-col items-start mb-12'>
              <img
                src='/assets/logo.png'
                alt='Pinglly'
                className='h-10 object-contain drop-shadow-[0_0_20px_rgba(99,102,241,0.6)]'
              />
              <span
                className='text-[8px] font-bold tracking-[0.4em] text-indigo-400 mt-1 uppercase ml-1'
                style={{ fontFamily: "var(--font-manrope)" }}
              >
                by TechEcho
              </span>
          ...
          <div className='relative z-10 space-y-6'>
            <div
              className='inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 text-[10px] font-bold uppercase tracking-widest'
              style={{ fontFamily: "var(--font-montserrat)" }}
            >
              <UserPlus className='h-3 w-3' /> Join the Next Generation
            </div>
            <h2
              className='text-5xl xl:text-6xl font-black text-white leading-[1.05] tracking-tight italic'
              style={{ fontFamily: "var(--font-manrope)" }}
            >
              Ready to
              <br />
            ...
            <p className='text-base text-white/60 max-w-[360px] leading-relaxed'>
              Initialize your high-performance CRM node. Join 12,000+ sales
              experts.
            </p>
          </div>
        ...
        <div className='flex-1 p-6 sm:p-10 lg:p-14 flex flex-col justify-center bg-white/[0.01] relative'>
          ...
          <div className='flex lg:hidden items-center gap-3 mb-8'>
            ...
            />
            <span
              className='text-[9px] font-bold tracking-[0.3em] text-indigo-400 uppercase'
              style={{ fontFamily: "var(--font-manrope)" }}
            >
              by TechEcho
            </span>
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
              ...
              <div className='space-y-1.5'>
                <Label
                  className='text-[10px] font-bold uppercase tracking-widest text-white/40 flex items-center gap-1.5'
                  style={{ fontFamily: "var(--font-montserrat)" }}
                >
