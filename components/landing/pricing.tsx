       ...
       <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
             {plans.map((p, i) => (
                ...
                >
                   {p.highlight && (
                      <div className="absolute top-6 right-6 sm:top-8 sm:right-8 px-4 py-1 bg-gradient-to-r from-orange-600 to-orange-400 text-white text-[9px] font-black uppercase tracking-widest rounded-full animate-pulse shadow-[0_0_15px_rgba(255,107,53,0.5)]">
                         Neural Priority
                      </div>
                   )}
