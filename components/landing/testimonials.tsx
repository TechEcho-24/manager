...
export function Testimonials() {
  return (
    <section className="py-32 px-6 bg-gradient-to-b from-transparent to-[#080810]">
       <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
             {testimonials.map((t, i) => (
                <div key={i} className="reveal group p-10 rounded-[3rem] bg-white/[0.02] border border-white/5 hover:border-orange-500/30 transition-all relative overflow-hidden" style={{ animationDelay: `${i * 100}ms` }}>
