...
export function Pathway() {
  return (
    <section id="process" className="py-32 px-6 bg-[#080810]/50 relative overflow-hidden">
       <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20">
          <div className="flex-1 space-y-12">
             ...
             <div className="space-y-2">
                {[
                   ...
                   <div key={i} className="reveal group flex items-start gap-8 p-8 rounded-3xl hover:bg-white/5 transition-all" style={{ animationDelay: `${i * 150}ms` }}>
                      <span className="text-5xl font-black text-orange-500/20 group-hover:text-orange-500 transition-colors italic">{s.step}</span>
                      <div className="space-y-2">
          ...
          <div className="flex-1 relative">
             <div className="aspect-square rounded-[4rem] bg-gradient-to-br from-orange-600/20 to-transparent border border-orange-500/20 relative overflow-hidden group">
